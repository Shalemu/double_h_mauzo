...
@font-face {
    ...
    src: url("<?php echo e(asset('fonts/montserrat/Montserrat-Regular.ttf')); ?>");
}
@font-face {
    font-family: "Montserrat-Medium";
    src: url("<?php echo e(asset('fonts/montserrat/Montserrat-Medium.ttf')); ?>");
}
@font-face {
    font-family: "ElMessiri-SemiBold";
    src: url("<?php echo e(asset('fonts/el_messiri/ElMessiri-SemiBold.ttf')); ?>");
}
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\PROJECT\double h\double h\resources\views/auth/register.blade.php ENDPATH**/ ?>