    ...
    <div class="card border shadow-sm">
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <div>
                ...
                <small class="text-muted"><?php echo e($shop->name ?? 'My Shop'); ?></small>
            </div>
...
<div class="modal fade" id="addCustomerModal" tabindex="-1" aria-hidden="true" style="margin-top: 200px;">
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <?php endif; ?>
            <form action="<?php echo e($customerStoreUrl); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <?php if(!empty($customerStoreShopId)): ?>
                    <input type="hidden" name="shop_id" value="<?php echo e($customerStoreShopId); ?>">
                <?php endif; ?>
...
<script>
// Builds a compact page list like [1, '...', 24, 25, 26, 27, 28, '...', 50]
// instead of listing every page number.
...
$(document).ready(function() {
    ...
    function updateProducts() {
        ...
        // Pagination UI — show a small window of pages around the current
        // one (plus first/last) instead of every page number at once.
        ...
        getPageWindow(currentPage, totalPages, 2).forEach(p => {
            if (p === '...') {
                pagination.append(`
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    checkoutBtn?.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch(<?php echo json_encode($checkoutUrl, 15, 512) ?>, {
                method: 'POST',
                headers: {
...
<?php /**PATH D:\PROJECTS\d\double_h_mauzo\resources\views/components/pos_core.blade.php ENDPATH**/ ?>