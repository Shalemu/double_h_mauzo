                        ...
                        <tr data-sale-type="<?php echo e(strtolower(trim($row['sale_type'] ?? 'retail'))); ?>">
                            ...
                            <td>
                                <button class="btn btn-sm btn-info view-receipt"
                                        ...
                                        data-total="<?php echo e(number_format($row['revenue'], 2)); ?>"
                                        data-sale-type="<?php echo e(ucfirst($row['sale_type'] ?? 'Retail')); ?>">
                                    View
                                </button>
                            </td>
                        </tr>
...
<?php /**PATH D:\PROJECTS\d\double_h_mauzo\resources\views/dashboard/sales/detail.blade.php ENDPATH**/ ?>