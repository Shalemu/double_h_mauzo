<div class="container-fluid mt-4 main-content">
    ...
    <div class="card shadow-sm" style="max-width: 1300px; margin: 0 auto;">
        ...
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Purchases Report for <?php echo e($shop->name ?? 'Double H Cosmetics Shop'); ?></h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="view-date" 
                                   data-url="<?php echo e(route('purchases.detail', ['shop' => $shop->id, 'date' => $purchaseData['date']])); ?>">
                                    <?php echo e($purchaseData['date']); ?>

                                </a>
                            </td>
                            <td><?php echo e(number_format($purchaseData['total'], 2)); ?></td>
                        </tr>
