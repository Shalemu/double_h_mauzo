                ...
                <div class="card credit-stat-card w-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold credit-stat-value text-info">Tsh <?php echo e(number_format($dailyCredit ?? 0, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card credit-stat-card w-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold credit-stat-value text-primary">Tsh <?php echo e(number_format($monthlyCredit ?? 0, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="card credit-stat-card w-100">
                    <div class="card-body d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <div class="fw-bold credit-stat-value">Tsh <?php echo e(number_format($totalCredit ?? 0, 2)); ?></div>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <table class="table table-hover mb-0 align-middle">
                    ...
                    <?php $__empty_1 = true; $__currentLoopData = $creditByDate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $date => $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        ...
                        <tr class="credit-date-row">
                            <td colspan="8">
                                <i class="bi bi-calendar-event me-2"></i><?php echo e($date); ?>
...
<?php /**PATH D:\PROJECTS\d\double_h_mauzo\resources\views/dashboard/credit/index.blade.php ENDPATH**/ ?>