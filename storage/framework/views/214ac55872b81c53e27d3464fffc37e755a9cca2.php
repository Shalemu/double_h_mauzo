<div class="container-fluid mt-4 main-content">
    ...
    <div class="card shadow-sm" style="max-width: 1300px; margin: 0 auto;">
        ...
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Expenses Report for <?php echo e($shop->name ?? 'Double H Cosmetics Shop'); ?></h5>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="javascript:void(0)" class="view-date" 
                                   data-url="<?php echo e(route('expenses.detail', ['shop' => $shop->id, 'date' => $expenseData['date']])); ?>">
...
<div class="modal fade" id="addExpenseModal" tabindex="-1" aria-hidden="true" style="margin-top: 150px;">
    <div class="modal-dialog">
        <div class="modal-content">
         <form action="<?php echo e(route('expenses.store', $shop->id)); ?>" method="POST" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
<?php /**PATH E:\PROJECT\double h\double h\resources\views/dashboard/expenses/index.blade.php ENDPATH**/ ?>