...
<?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <tr>
        ...
        <td>
            ...
            <a href="<?php echo e(route('staff.manage.edit', $s->id)); ?>" class="btn btn-sm btn-info">Edit</a>


        <form action="<?php echo e(route('staff.manage.destroy', $s->id)); ?>" method="POST" style="display:inline-block;">
            <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="addStaffModal" tabindex="-1">
        <div class="modal-dialog modal-lg" style="margin-top:160px;">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('staff.manage.store')); ?>">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\PROJECTS\d\double_h_mauzo\resources\views/dashboard/admin/staff.blade.php ENDPATH**/ ?>