        ...
        <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="btn-group mb-2">
                    <a href="<?php echo e(route('sales.export.excel', [$shop->id, $date])); ?>" class="btn btn-success btn-sm">Export Excel</a>
                    <a href="<?php echo e(route('sales.export.pdf', [$shop->id, $date])); ?>" class="btn btn-danger btn-sm">Export PDF</a>
                </div>
