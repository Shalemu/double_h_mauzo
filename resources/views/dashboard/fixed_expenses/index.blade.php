<div class="container-fluid mt-4 main-content">
    ...
    <div class="card shadow-sm" style="max-width: 1300px; margin: 0 auto;">
        ...
        <div class="card-header bg-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Fixed Expenses Report for {{ $shop->name ?? 'Double H Cosmetics Shop' }}</h5>
                ...
                <table class="table table-bordered table-hover table-sm text-center" id="fixed-expenses-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('fixed-expenses.edit', $expense->id) }}" class="btn btn-sm btn-warning">Edit</a>
                                <form action="{{ route('fixed-expenses.destroy', $expense->id) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
